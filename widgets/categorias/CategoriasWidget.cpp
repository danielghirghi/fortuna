    ...
    , ui(new Ui::CategoriasWidget)
{
    ...
    connect(ui->edtPesquisar, &QLineEdit::returnPressed, this, &CategoriasWidget::on_btnPesquisar_clicked);
}
...
void CategoriasWidget::carregarCategorias()
{
    ...
    ui->lblQuantidade->setText(QString::number(categorias.count()) + " categorias");
...
void CategoriasWidget::on_btnLimpar_clicked()
{
    ui->edtPesquisar->setText("");
    carregarCategorias();
}

void CategoriasWidget::on_btnPesquisar_clicked()
{
    ui->tblCategorias->setRowCount(0);
    ...
    CategoriasRepository repository;
    QList<Categoria> categorias = repository.pesquisar(busca);
